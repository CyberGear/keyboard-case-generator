...
object McuProC {
  ...
  def addOn(): Solid = {
    ...
    val frontPanel = Cube(pcbX + 4.mm, 1.5.mm, 8.5.mm).moveY(pcbY).moveX(-2.mm)
    val frontPanelBrace1 = Cube(2.mm, 4.mm, pcbZ * 3).moveY(pcbY - 4.mm).moveX(-2.mm)
    val frontPanelBrace2 = Cube(2.mm, 4.mm, pcbZ * 3).moveY(pcbY - 4.mm).moveX(pcbX)
