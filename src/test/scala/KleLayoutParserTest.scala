import model.inputmodel.{Key, Layout}
...
class KleLayoutParserTest extends AnyFlatSpec with Matchers with Utils {
  ...
  it should "parse ANSI 104 layout from kle" in {
    val actual   = readLayoutYaml(
      """---
        |layout: >
    ...
    val expected = readLayoutYaml(
      """---
        ...
        |  [{w:1.25},"",{w:1.25},"",{w:1.25},"",{w:6.25},"",{w:1.25},"",{w:1.25},"",{w:1.25},"",{w:1.25},"",{x:0.25},"","","",{x:0.25,w:2},"",""]""".stripMargin
    )
